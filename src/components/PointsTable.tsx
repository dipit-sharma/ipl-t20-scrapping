          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {teams.map((team, index) => (
              ...
              >
                ...
                <td className="px-4 py-4 whitespace-nowrap text-center text-green-600 dark:text-green-400 font-semibold">
                  {team.won}
                </td>
                <td className="px-4 py-4 whitespace-nowrap text-center text-red-600 dark:text-red-400 font-semibold">
                  {team.lost}
                </td>
                <td className="px-4 py-4 whitespace-nowrap text-center text-gray-600 dark:text-gray-400">
                  {team.tied}
                </td>
                <td className="px-4 py-4 whitespace-nowrap text-center text-gray-600 dark:text-gray-400">
                  {team.noResult}
                ...
                <td
                  className={`px-4 py-4 whitespace-nowrap text-center font-semibold ${getNetRunRateColor(
                    team.netRunRate
                  )}`}
                >
                  {team.netRunRate}
                ...
                <td className="px-4 py-4 whitespace-nowrap text-center">
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${getQualificationColor(
                      team.qualification,
                      team.position
                    )}`}
                  >
        ...
        {teams.map((team) => (
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div
                  className={`text-lg font-semibold ${getNetRunRateColor(
                    team.netRunRate
                  )}`}
                >
                  {team.netRunRate}
